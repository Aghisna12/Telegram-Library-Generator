/**
*This library was generated from 'http://aghisna.xyz/libgram.php?source=javascript'
*Date : 2020-07-21 08:15:14
...
- All other entities can't contain each other.Links tg://user?id=<user_id> can be used to mention a user by their ID without using a username. Please note:To use this mode, pass MarkdownV2 in the parse_mode field. Use the following syntax in your message:Please note:To use this mode, pass HTML in the parse_mode field. The following tags are currently supported:Please note:This is a legacy mode, retained for backward compatibility. To use this mode, pass Markdown in the parse_mode field. Use the following syntax in your message:Please note:
	...
	*/
	getFile(
		...
		return this.requestApi('getFile', this.buildQuery({
			'file_id':file_id
		}));
	}
	...
	*/
	exportChatInviteLink(
		...
		return this.requestApi('exportChatInviteLink', this.buildQuery({
			'chat_id':chat_id
		}));
	}
	...
	*/
	deleteChatPhoto(
		...
		return this.requestApi('deleteChatPhoto', this.buildQuery({
			'chat_id':chat_id
		}));
	}
	...
	*/
	unpinChatMessage(
		...
		return this.requestApi('unpinChatMessage', this.buildQuery({
			'chat_id':chat_id
		}));
	}
	...
	*/
	leaveChat(
		...
		return this.requestApi('leaveChat', this.buildQuery({
			'chat_id':chat_id
		}));
	}
	...
	*/
	getChat(
		...
		return this.requestApi('getChat', this.buildQuery({
			'chat_id':chat_id
		}));
	}
	...
	*/
	getChatAdministrators(
		...
		return this.requestApi('getChatAdministrators', this.buildQuery({
			'chat_id':chat_id
		}));
	}
	...
	*/
	getChatMembersCount(
		...
		return this.requestApi('getChatMembersCount', this.buildQuery({
			'chat_id':chat_id
		}));
	}
	...
	*/
	deleteChatStickerSet(
		...
		return this.requestApi('deleteChatStickerSet', this.buildQuery({
			'chat_id':chat_id
		}));
	}
	...
	*/
	setMyCommands(
		...
		return this.requestApi('setMyCommands', this.buildQuery({
			'commands':commands
		}));
	}
